...
const RegisterForm = () => {
  ...
  return (
    <form
      ...
      className="max-w-[25rem] w-[23rem] flex flex-col mx-auto p-4 gap-6 outline-none rounded-md shadow-md shadow-gray-400 dark:shadow-gray-800 bg-gray-100 dark:bg-gray-800"
    >
